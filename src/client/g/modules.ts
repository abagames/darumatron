...
export class MoveWasd extends Module {
  constructor(actor: g.Actor, public speed = 1, public angleVel = 0) {
    super(actor);
  }
  ...
  update() {
    ...
    if (this.angleVel > 0) {
      const a = g.Vector.getAngle(g.ui.stick);
      const oa = g.wrap(a - this.actor.angle, -g.p.PI, g.p.PI);
